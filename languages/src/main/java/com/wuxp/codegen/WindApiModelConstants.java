...
public final class WindApiModelConstants {
    ...
    private static final String PAGINATION_GENERIC_NAME = "Pagination<T>";

    private static final String API_RESPONSE_GENERIC_NAME = "ApiResponse<T>";

    public static final JavaCodeGenClassMeta JAVA_API_RESPONSE = new JavaCodeGenClassMeta(ApiResponse.class, API_RESPONSE_GENERIC_NAME, ApiResponse.class.getName(), true);

    public static final JavaCodeGenClassMeta JAVA_PAGINATION = new JavaCodeGenClassMeta(Pagination.class, PAGINATION_GENERIC_NAME, Pagination.class.getName(), true);
