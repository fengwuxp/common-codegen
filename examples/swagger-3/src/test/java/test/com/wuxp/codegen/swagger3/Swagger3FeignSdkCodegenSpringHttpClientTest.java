...
@Slf4j
class Swagger3FeignSdkCodegenSpringHttpClientTest {
    ...
    void testCodeGenFeignClientByStater() throws Exception {
        ...
        packageMapStrategy.setFileNamSuffix("Client");

        LanguageDescription language = LanguageDescription.JAVA;
        ClientProviderType clientProviderType = ClientProviderType.SPRING_HTTP;
