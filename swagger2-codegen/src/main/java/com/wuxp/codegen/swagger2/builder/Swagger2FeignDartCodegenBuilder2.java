 ...
 */
@Slf4j
public class Swagger2FeignDartCodegenBuilder2 extends AbstractLoongCodegenBuilder {
    ...
    public static Swagger2FeignDartCodegenBuilder2 builder() {
        return new Swagger2FeignDartCodegenBuilder2();
    }

    public Swagger2FeignDartCodegenBuilder2 ignoreFields(Map<Class<?>, List<String>> ignoreFields) {
        this.ignoreFields = ignoreFields;
        return this;
    }

    public Swagger2FeignDartCodegenBuilder2 typeAlias(Map<DartClassMeta, List<String>> typeAlias) {
        this.typeAlias = typeAlias;
        return this;
    }

    public Swagger2FeignDartCodegenBuilder2 sdkIndexFileName(String sdkIndexFileName) {
