...
public class DartClassMeta extends CommonCodeGenClassMeta {
  ...
  public final static DartClassMeta BUILT_LIST = new DartClassMeta("BuiltList", "BuiltList<T>", ClassType.CLASS, false, OBJECT,
  ...
  public final static DartClassMeta BUILT_MAP = new DartClassMeta("BuiltMap", "BuiltMap<K,V>", ClassType.CLASS, false, OBJECT,
      BUILT_COLLECTION_PATH);
  ...
  public final static DartClassMeta BUILT_SET = new DartClassMeta("BuiltSet", "BuiltSet<V>", ClassType.CLASS, false, OBJECT,
      BUILT_COLLECTION_PATH);
  ...
  public final static DartClassMeta BUILT_ITERABLE = new DartClassMeta("BuiltIterable", "BuiltIterable<T>", ClassType.CLASS, false, OBJECT,
      BUILT_COLLECTION_PATH);
   ...
   * Serializers
   */
  public final static DartClassMeta BUILT_SERIALIZERS = new DartClassMeta("Serializers", null, ClassType.CLASS, false, OBJECT,
      "/serializers");
